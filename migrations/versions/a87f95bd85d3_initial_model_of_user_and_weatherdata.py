"""Initial model of User and WeatherData

Revision ID: a87f95bd85d3
Revises: 
Create Date: 2025-05-01 11:04:16.159914
...
def upgrade():
    ...
    sa.Column('weather', sa.Float(), nullable=False),
